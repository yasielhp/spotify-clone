...
const SongControl = ({ audio }) => {
	...
	return (
		<div className="flex gap-x-3 pt-2 text-xs">
			<span className="w-12 text-right opacity-50">{formatTime(currentTime)}</span>
			...
			<span className="w-12 opacity-50">{duration ? formatTime(duration) : '0:00'}</span>
		</div>
	)
}
...
export function Player() {
	...
	return (
		<div className="z-50 flex w-full flex-row justify-between px-1">
			...
			<div className="grid flex-1 place-content-center gap-4">
				<div className="flex flex-col items-center justify-center">
					<button
						...
						className="rounded-full bg-white p-2 disabled:opacity-25"
						onClick={handleClick}
					>
